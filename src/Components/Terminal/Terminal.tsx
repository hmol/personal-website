	...
	render() {
        return (
			...
			<div className="terminal-container">
					<TerminalLine command="henrik.mail"
												print="molnes@gmail.com"
												href="mailto:molnes@gmail.com">
					</TerminalLine>
					<TerminalLine command="henrik.currentWork"
												print="Developer at Kron">
					</TerminalLine>
					<TerminalLine command="henrik.experience"
								  print={new Date().getFullYear() - 2012 + " years"}>
					</TerminalLine>
