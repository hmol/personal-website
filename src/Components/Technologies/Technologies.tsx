            ...
            <div className="Technologies">
                    ...
                    <div className="techitems-container">
                        <div className="tech-items-column">
                            ...
                            <TechItem name="java" level={4}></TechItem>
                            <TechItem name="angular" level={7}></TechItem>
                            <TechItem name="react" level={5}></TechItem>
                            <TechItem name="powershell" level={7}></TechItem>
                            <TechItem name="bash" level={7}></TechItem>
                            <TechItem name="linux" level={6}></TechItem>
                        ...
                        <div className="tech-items-column">
                            ...
                            <TechItem name="graphql" level={3}></TechItem>
                            <TechItem name="elasticsearch" level={6}></TechItem>
                            ...
                            <TechItem name="docker" level={5}></TechItem>
                            <TechItem name="kubernetes" level={2}></TechItem>
                        </div>
                    </div>
            </div>
            );
